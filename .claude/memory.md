...
- 📖 详细（持久性矩阵 + sethome 逻辑 + 模型切换教训 + PR 技巧）→ `archive-feishu-channel.md`「2026-07-06 #49」
...
- 📖 详细（containerd 踩坑 + 迁移步骤 + 验证 + build arg 完整命令）→ `archive-platform-infra.md`「2026-07-06 #50」
